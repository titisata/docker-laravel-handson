            ...
            <!-- <div class="mt-2 card"> -->
                ...
                <div class="card-body">
                    @forelse($experiences as $experience)
                     ...
                     <a class="btn btn-pink rounded-pill text-white my-1 w-100 shadow" href="{{ $experienceFolder->id }}/{{ $experience->id }}?{{ explode('?', str_replace(url('/'),"",request()->fullUrl()))[1] }}">{{ $experience->name }}</a>
