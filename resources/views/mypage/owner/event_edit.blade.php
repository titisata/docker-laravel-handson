...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form name="deleteform" action="/mypage/owner/event_edit_delete" method="POST" onsubmit='return check();'>
                @csrf     
            ...
            <form class="my-4" action="/mypage/owner/action_event_delete" method="POST">
                @csrf
