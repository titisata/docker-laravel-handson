    ...
    <div class="card mt-3 col-4">
        ...
        <table class="table table-hover">
            ...
            @endif
                <tr>
                    <td>
                        <a class="link" href="/mypage/partner/goods/{{ $decrease_good->goods_folder->id }}">
                            <p>{{ $decrease_good->name }}</p>
                        </a>
                    </td>
                    <td>
                        <p>{{ $decrease_good->goods_folder->user->name }}</p>
                    </td>
