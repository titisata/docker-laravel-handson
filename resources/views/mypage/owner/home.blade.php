                ...
                <table class="table table-hover">
                    @forelse ($reserved_experiences as $reserved_experience)
                        @if ($loop->first)
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">宿泊有無</th>
                                    <th scope="col">予約体験名</th>
                                    <th scope="col">体験種別</th>
                                    <th scope="col">予約日</th>
                                    <th scope="col">人数</th>
                                    <th scope="col">宿泊</th>
                                    <th scope="col">食事</th>
                        ...
                        <tr>
                            ...
                            <td>
                            <p>大人{{ $reserved_experience->quantity_adult }}人<br>子ども{{ $reserved_experience->quantity_child }}人</p>
                            </td>
                            <td>
                            ...
                            <td><p>連絡事項: {{ $reserved_experience->message }}</p></td>
                            <td> @if( $reserved_experience->status == '対応待ち')
