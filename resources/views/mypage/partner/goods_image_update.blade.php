...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form enctype="multipart/form-data" action="/mypage/partner/action_goods_image_update/{{ $images->id }}" method="POST">
                @csrf
                ...
                <p>現在表示されている画像</p>
                <img src="/storage/{{ $images->image_path }}" alt="" style="width: 200px;height: 140px; object-fit: cover;">
                <p></p>
